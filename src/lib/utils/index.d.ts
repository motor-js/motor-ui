...
export type configType = { host: string, secure: boolean, port: number, prefix: string, appId: string }
...
export type chartColorType = Array<string> | 'divergent13' | 'divergent9' | 'goya' | 'red' | 'blue' | 'gray' | 'pink' | 'grape' | 'violet' | 'indigo' | 'blue' | 'cyan' | 'teal' | 'green' | 'lime' | 'yellow' | 'orange' | 'base'
export type showLegendType = boolean | 'right' | 'bottom'
export type otherTotalSpecType = boolean | { qOtherLabel: string, qOtherCount: string }
