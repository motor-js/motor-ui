...
const HeatmapWrapperNoData = styled.div`
  ${globalStyle};
...
const HeatmapNoDataContent = styled.div`
  ${globalStyle};
  ${(props) => props.gridArea && `grid-area: ${props.gridArea};`};
...
HeatmapWrapper.defaultProps = {};
Object.setPrototypeOf(HeatmapWrapper.defaultProps, defaultProps);

HeatmapWrapperNoData.defaultProps = {};
Object.setPrototypeOf(HeatmapWrapperNoData.defaultProps, defaultProps);

HeatmapNoDataContent.defaultProps = {};
Object.setPrototypeOf(HeatmapNoDataContent.defaultProps, defaultProps);

export { HeatmapWrapper, HeatmapWrapperNoData, HeatmapNoDataContent };
