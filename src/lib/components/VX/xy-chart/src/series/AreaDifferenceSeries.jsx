...
export default class AreaDifferenceSeries extends React.PureComponent {
  render() {
    ...
    if (
      ...
      console.warn(
        "AreaDifferenceSeries expects exactly two AreaSeries children"
      );
    ...
    if (data1.length !== data2.length) {
      console.warn(
        "AreaDifferenceSeries children should have the same data length"
      );
      ...
      <g>
        ...
        {childArray.map((Child) =>
          React.cloneElement(Child, {
            ...
            interpolation,
            disableMouseEvents:
              Child.props.disableMouseEvents || disableMouseEvents,
            fill: "transparent",
            margin,
          })
        )}
