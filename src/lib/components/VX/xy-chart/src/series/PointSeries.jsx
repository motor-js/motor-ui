...
import { FocusBlurHandler } from "../../../shared/src";
      ...
      <Group style={disableMouseEvents ? noEventsStyles : null}>
        {data.map((d, i) => {
          ...
          const computedFillOpacity =
            d.fillOpacity || callOrValue(fillOpacity, d, i);
          const computedStroke = d.stroke || callOrValue(stroke, d, i);
          const computedStrokeWidth =
            d.strokeWidth || callOrValue(strokeWidth, d, i);
          const computedStrokeDasharray =
            d.strokeDasharray || callOrValue(strokeDasharray, d, i);
