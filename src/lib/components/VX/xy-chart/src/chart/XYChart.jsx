...
import { WithTooltip } from "../../../shared/src";
...
import {
  scaleShape,
  themeShape,
  stringNumberDateObjectPropType,
} from "../utils/propShapes";
...
class XYChart extends React.PureComponent {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (
      ["margin", "xScale", "yScale"].some(
        ...
        (prop) =>
          !shallowCompareObjectEntries(this.props[prop], nextProps[prop])
      )
    ) {
      shouldComputeScales = true;
    }
    if (shouldComputeScales)
  ...
  getNumTicksAndGridValues(innerWidth, innerHeight) {
    ...
    return {
      numXTicks: propOrFallback(
        xAxis && xAxis.props,
        "numTicks",
        numTicksForWidth(innerWidth)
      ),
      numYTicks: propOrFallback(
        yAxis && yAxis.props,
        "numTicks",
      ...
      xGridValues:
        xGridValues ||
        (xAxis && xAxis.props && xAxis.props.tickValues
          ? xAxis.props.tickValues
          : null),
      yGridValues:
        yGridValues ||
        (yAxis && yAxis.props && yAxis.props.tickValues
          ? yAxis.props.tickValues
          : null),
    };
  }
  ...
  render() {
    ...
    const {
      ...
      xGridValues,
      yGridValues,
    } = this.getNumTicksAndGridValues(innerWidth, innerHeight);
              ...
              if (isAxis(name)) {
                ...
                const labelOffset =
                  typeof Child.props.labelOffset === "number"
                    ...
                    : (name === "YAxis" &&
                        Y_LABEL_OFFSET * margin[Child.props.orientation]) ||
                      0;
                if (name === "XAxis") {
                ...
                return React.cloneElement(Child, {
                  ...
                  rangePadding:
                    ...
                    (name === "XAxis" ? xScale.offset : undefined),
                  axisStyles: {
                ...
                return React.cloneElement(Child, {
                  ...
                  onClick:
                    Child.props.onClick ||
                    (Child.props.disableMouseEvents
                      ? undefined
                      : this.handleClick),
                  onMouseLeave:
