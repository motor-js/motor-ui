...
const SearchBar = styled.div`
  ...
  border-color: ${props => selectColor(props.theme.search.title.borderColor, props.theme)};
  border-radius: ${props => props.theme.search.title.radius};  
  background-color: ${props => selectColor(props.theme.search.color.background, props.theme)};
  width: 100%;
  height: 100%;
...
const SearchInput = styled.input`
  ...
  &::placeholder {
    color: ${props => selectColor(props.theme.search.color.placeholder, props.theme)};
  }
  `
...
const SuggestionsItem = styled.li`
  ...
  &:hover {
    background-color: ${props => selectColor(props.theme.search.suggestions.hoverColor, props.theme)};
  }
`
...
const SuggestionsItemTitle = styled.div`
  ...
  padding: 2px;
  font-weight: bold;
  color: ${props => selectColor(props.theme.search.suggestions.titleColor, props.theme)};
`

const SuggestionsItemValues = styled.div`
  font-size: ${props => props.theme.global.size.font[props.size]};
  padding: 2px;
  color: ${props => selectColor(props.theme.search.suggestions.valueColor, props.theme)};
`
