...
const handleTableCellStyle = props => {
  ...
  // select Bkg color
  const selBkgColor = selectColor(props.theme.table.color.selectedBackground, props.theme)
  ...
  if (selectionsActive) {
    ...
    `
      ...
      return css`
font-weight: ${props => (props.highlightOnSelection
    ? null
    : 'bold')
};
background-color: ${props => (props.highlightOnSelection
    ? `${selBkgColor} !important`
    : null)
};
opacity: ${props => (props.highlightOnSelection
    ? 0.8
    : null)
};
...
const HeaderRow = styled.tr`
  & th:first-child {
    border-left: ${props => `${props.gridPxl} solid ${selectColor(props.theme.table.wrapper.borderColor, props.theme)}`};
   }
   & th {
    border-top: ${props => `1px solid ${selectColor(props.theme.table.wrapper.borderColor, props.theme)}`};
    border-bottom: ${props => `1px solid ${selectColor(props.theme.table.header.borderColor, props.theme)}`};
    border-right: ${props => `${props.gridPxl} solid ${selectColor(props.theme.table.cells.borderColor, props.theme)}`};
   }
   & th:last-child {
    border-right: ${props => `${props.gridPxl} solid ${selectColor(props.theme.table.wrapper.borderColor, props.theme)}`};
   }
`

const HeaderCell = styled.th`
  background-color: ${props => selectColor(props.headerBackgroundColor || props.theme.table.color.headerBackground, props.theme)};
  text-align: ${props => props.headerAlignment};
  padding: ${props => props.theme.table.header.padding};
  color: ${props => selectColor(props.headerFontColor || props.theme.global.color.font, props.theme)};
  position: sticky;
  top: 0;
  z-index: 5;
`
...
const GrandTotalsRow = styled.tr`
  & th:first-child {
   ...
   & th {
   border-bottom: ${props => `1px solid ${selectColor(props.theme.table.totals.borderColor, props.theme)}`};
   border-right: ${props => `${props.gridPxl} solid ${selectColor(props.theme.table.cells.borderColor, props.theme)}`};
   }
   & th:last-child {
    border-right: ${props => `${props.gridPxl} solid ${selectColor(props.theme.table.wrapper.borderColor, props.theme)}`};
...
const TableBodyStyle = styled.tbody`
  ...
  & tr:nth-last-child(2) td {
    border-bottom: ${props => `${props.gridPxl} solid ${selectColor(props.theme.table.wrapper.borderColor, props.theme)}`};
  }
`
...
const TableRowStyle = styled.tr`
  ...
  & td {
    ...
    if (props.bandedRows === true) {
      return props.i % 2 === 1 ? selectColor(props.theme.table.color.evenRows, props.theme) : selectColor(props.theme.table.color.oddRows, props.theme)
    }

    return selectColor(props.theme.table.color.bodyBackground, props.theme)
  }};
    border-bottom: ${props => `${props.gridPxl} solid ${selectColor(props.theme.table.cells.borderColor, props.theme)}`};
    border-right: ${props => `${props.gridPxl} solid ${selectColor(props.theme.table.cells.borderColor, props.theme)}`};
  };
  & td:last-child {
    border-right: ${props => `${props.gridPxl} solid ${selectColor(props.theme.table.wrapper.borderColor, props.theme)}`};
  ...
  &:hover {
    background-color: ${props => `${props.gridPxl} solid ${selectColor(props.theme.table.color.hover, props.theme)}`};
  };
`
