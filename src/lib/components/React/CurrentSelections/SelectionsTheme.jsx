...
const SelectionsWrapper = styled.div`
  ...
  background-color: ${props => selectColor(props.theme.selections.wrapper.backgroundColor, props.theme)};
  border-color: ${props => selectColor(props.theme.selections.wrapper.borderColor, props.theme)};
`
...
const SelectionItem = styled.span`
  ...
  border-color:  ${props => selectColor(props.theme.selections.color.border, props.theme)}; 
  border-radius: ${props => props.theme.selections.item.radius};
  background-color: ${props => selectColor(props.theme.selections.item.backgroundColor, props.theme)};
  cursor: default;
  user-select: none;
`
...
const NoSelections = styled.div`
  margin: 10px;
  color: ${props => selectColor(props.theme.selections.color.defaultFont, props.theme)};
  user-select: none;
`

const SelectedTitle = styled.span`
  margin: 0 0 0 5px;
  color: ${props => selectColor(props.theme.selections.color.fontTitle, props.theme)};
  font-weight:  ${props => props.theme.selections.item.titleFontWeight};
  user-select: none;
`

const SelectedValue = styled.span`
  color:${props => selectColor(props.theme.selections.color.item, props.theme)};
  text-align: top;
`
...
const SelectionsX = styled.span`
  ...
  border: 1px solid ${props => selectColor(props.theme.selections.item.backgroundColor, props.theme)};
  &:hover {
    border: 1px solid ${props => selectColor(props.theme.selections.color.clear, props.theme)};
  }
`

const XStyled = styled(X)`
  padding: 1px 1px;
  color: ${props => selectColor(props.theme.selections.color.clear, props.theme)};
`
