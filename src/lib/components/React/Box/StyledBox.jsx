...
const basisStyle = css`
  flex-basis: ${props => BASIS_MAP[props.basis]
...
const flexStyle = css`
  flex: ${props => `${flexGrowShrinkProp(props.flex)}${
...
const heightObjectStyle = css`
  ${props => props.heightProp.max
    && css`
      max-height: ${props.heightProp.max};
    `};
  ${props => props.heightProp.min
    && css`
...
const widthObjectStyle = css`
  ${props => props.widthProp.max
    && css`
      max-width: ${props.widthProp.max};
    `};
  ${props => props.widthProp.min
    && css`
