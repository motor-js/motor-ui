...
import { allColors } from "../../VX/theme";
...
const legendScale = scaleOrdinal({
  range: seriesProps.map(({ stroke, strokeDasharray }) => ({
    stroke,
    strokeDasharray,
  })),
...
class LineSeriesExample extends React.PureComponent {
  constructor(props) {
    ...
    this.restartProgrammaticTooltip = this.restartProgrammaticTooltip.bind(
      this
    );
                ...
                <WithTooltip renderTooltip={this.renderTooltip}>
                  {({ onMouseLeave, onMouseMove, tooltipData }) => (
                    <ResponsiveXYChart
                      ...
                      onMouseMove={
                        disableMouseEvents || stickyTooltip ? null : onMouseMove
                      }
                      onMouseLeave={
                        disableMouseEvents || stickyTooltip
                          ? null
                          : onMouseLeave
                      }
                      renderTooltip={null}
                    ...
                    >
                      ...
                      <CrossHair
                        ...
                        showCircle={
                          useVoronoiTrigger || !this.state.programmaticTrigger
                        }
                        showMultipleCircles={
                          !useVoronoiTrigger && showMultipleCircles
                        }
                      />
